...
sleep 5
  ...
  NO_OF_ORDERERS=1
  echo ${NO_OF_ORDERERS}
  CPWD="/home/paperspace/HLF_1.4.3_BACK"
  SourcePATH="/home/paperspace/HLF_1.4.3_BACK/tbfc-api"
  # CPWD="/usr/CLIF"
  ...
  orgDetails[2,0]="carrier"
  orgDetails[3,0]="buyer"
  orgDetails[4,0]="seller"
  orgDetails[0,2]="BuyerBank"
  orgDetails[1,2]="SellerBank"
  orgDetails[2,2]="Carrier"
  orgDetails[3,2]="Buyer"
  orgDetails[4,2]="Seller"
  orgDetails[0,1]=1
  orgDetails[1,1]=1
  orgDetails[2,1]=1
  orgDetails[3,1]=1
